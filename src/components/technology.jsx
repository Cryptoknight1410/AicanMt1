...
function Technology() {
  ...
  return (
    ...
    <div className={`${colors.lightbluish} flex-col flex mb-9 mt-9 rounded-3xl w-4/5 box-border p-5`}>
      <div className="p-8 flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="max-w-3xl mx-auto text-center md:text-left">
          <div className="px-3 py-4">
            <h2 className={`text-lg lg:text-5xl ${colors.subheadingColor} sm:text-lg font-bold mb-16`}>
  ...
  <h3 className={`text-sm my-3 sm:text-base lg:text-lg ${colors.headingColor} font-semibold text-center cursor-pointer`}>START YOUR TRANSFORMATION NOW</h3>
   <AiOutlineArrowRight  className={`hidden xsm:block cursor-pointer ${colors.textPrimary} font-semibold`}/>
  </div>
</div>
    </div>
  </div>
