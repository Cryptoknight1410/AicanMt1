...
function Card1() {
  ...
  const handleVisibilityChange = (isVisible2) => {
    if (isVisible) {
            ...
            >
              <div className="p-1 md:p-8 flex flex-col md:flex-row items-center justify-center flex-wrap">
                <div className="px-2 md:px-6  text-center  w-[90%] ">
                  <h3
                    className={`${colors.headingColor}  text-base font-bold mt-7`}
                  >
                  ...
                  >
                    Experience the transformative power of AICAN and witness a
                    rapid return on investment, with the potential to achieve a
                    25% reduction in operational costs within just three months.
                    Unlock sustainable business growth, increased profitability,
                    and enhanced efficiency with AICAN at your side.
                  </p>
                </div>
              </div>
              <div className="flex justify-around items-center flex-wrap mt-20">
                ...
                <div className="flex flex-col flex-wrap">
                  ...
                  <div className="w-52 lg:text-base text-base text-center font-medium">
                    Increse in machine on-time through cycle times and micro
                    stop tracing
                  </div>
                </div>
                ...
                <div className="flex flex-col flex-wrap">
                  ...
                  <div className="w-52 lg:text-base text-base text-center font-medium">
                    Increase in on-time order fulfillment with error detection
                    on ground level
                  </div>
                </div>
              </div>
