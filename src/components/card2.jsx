    ...
    <div className="flex flex-col justify-center items-center mt-16">
      <div className={`flex-col flex mb-9 mt-9 rounded-3xl w-4/5 box-border p-5 ${colors.card2}` }>
        <div className="p-8 flex flex-col md:flex-row items-center justify-center">
          <div className="max-w-3xl mx-auto text-center md:text-left">
            <div className="px-6 py-4 text-center">
              ...
              <h2 className={`text-lg lg:text-5xl sm:text-lg font-bold  ${colors.subheadingColor}`}>
        ...
        <div className="flex flex-col flex-wrap md:mt-0 mt-5">
            <div className={`text-center ${colors.textTomotoColor} font-extrabold sm:text-5xl text-2xl lg:text-9xl`}>
              1
            </div>
            <div className="w-52 md:w-96 lg:text-lg text-base text-center font-medium">
        ...
        <div className=" items-center flex flex-col ">
          ...
          <div className="flex items-baseline justify-center ">
            <h3
              className={`text-sm my-3 sm:text-base lg:text-lg ${colors.textTomotoColor} font-semibold text-center cursor-pointer`}
            >
